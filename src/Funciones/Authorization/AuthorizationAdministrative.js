...
const AuthorizationAdministrative = () => {
    ...
    const authorizeProvider = async () => {
        ...
        if (isOwner){
            try {
                const tx = await contract.updateadministrativeStaff(providerAddress,isAuthorized);
                await tx.wait();
    ...
    return(
        <div className="bg-white rounded-2xl shadow-xl p-8">
            <Sidebar />
            <h2 className="text-2xl font-semibold mb-4">Assignment of permissions to administrative staff</h2>
...
export default AuthorizationAdministrative;